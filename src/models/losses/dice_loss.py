...
from src.models.losses.ce import CrossentropyND, TopKLoss, WeightedCrossEntropyLoss
...
class TverskyLoss(nn.Module):
    ...
    def forward(self, x, y, loss_mask=None, ignore_index=None):
        shp_x = x.shape
...
class FocalTversky_loss(nn.Module):
    ...
    def forward(self, net_output, target, ignore_index=None):
        tversky_loss = 1 + self.tversky(net_output, target, ignore_index=ignore_index) # = 1-tversky(net_output, target)
